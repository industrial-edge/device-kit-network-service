...
const file_Network_proto_rawDesc = "" +
	...
	"\x05label\x18\x01 \x01(\tR\x05label\"\xa9\b\n" +
	"\tInterface\x12*\n" +
	...
	"\x06Routes\x18\t \x03(\v2/.siemens.iedge.dmapi.network.v1.Interface.RouteR\x06Routes\x1aT\n" +
	"\n" +
	"StaticConf\x12\x12\n" +
	...
	"\x06Metric\x18\x04 \x01(\rR\x06Metric\"\xf4\x01\n" +
	...
	"\rApplySettings\x12/.siemens.iedge.dmapi.network.v1.NetworkSettings\x1a\x16.google.protobuf.EmptyB\x1aZ\x18.;siemens_iedge_dmapi_v1b\x06proto3"
...
var file_Network_proto_goTypes = []any{
	...
	(*Interface_Route)(nil),                  // 7: siemens.iedge.dmapi.network.v1.Interface.Route
	nil,                                      // 8: siemens.iedge.dmapi.network.v1.Interface.L2.AuxiliaryAddressesEntry
	nil,                                      // 9: siemens.iedge.dmapi.network.v1.NetworkSettings.LabelMapEntry
...
var file_Network_proto_depIdxs = []int32{
	...
	7,  // 3: siemens.iedge.dmapi.network.v1.Interface.Routes:type_name -> siemens.iedge.dmapi.network.v1.Interface.Route
	2,  // 4: siemens.iedge.dmapi.network.v1.NetworkSettings.Interfaces:type_name -> siemens.iedge.dmapi.network.v1.Interface
	9,  // 5: siemens.iedge.dmapi.network.v1.NetworkSettings.LabelMap:type_name -> siemens.iedge.dmapi.network.v1.NetworkSettings.LabelMapEntry
	8,  // 6: siemens.iedge.dmapi.network.v1.Interface.L2.AuxiliaryAddresses:type_name -> siemens.iedge.dmapi.network.v1.Interface.L2.AuxiliaryAddressesEntry
	10, // 7: siemens.iedge.dmapi.network.v1.NetworkService.GetAllInterfaces:input_type -> google.protobuf.Empty
	0,  // 8: siemens.iedge.dmapi.network.v1.NetworkService.GetInterfaceWithMac:input_type -> siemens.iedge.dmapi.network.v1.NetworkInterfaceRequest
	1,  // 9: siemens.iedge.dmapi.network.v1.NetworkService.GetInterfaceWithLabel:input_type -> siemens.iedge.dmapi.network.v1.NetworkInterfaceRequestWithLabel
	3,  // 10: siemens.iedge.dmapi.network.v1.NetworkService.ApplySettings:input_type -> siemens.iedge.dmapi.network.v1.NetworkSettings
	3,  // 11: siemens.iedge.dmapi.network.v1.NetworkService.GetAllInterfaces:output_type -> siemens.iedge.dmapi.network.v1.NetworkSettings
	2,  // 12: siemens.iedge.dmapi.network.v1.NetworkService.GetInterfaceWithMac:output_type -> siemens.iedge.dmapi.network.v1.Interface
	2,  // 13: siemens.iedge.dmapi.network.v1.NetworkService.GetInterfaceWithLabel:output_type -> siemens.iedge.dmapi.network.v1.Interface
	10, // 14: siemens.iedge.dmapi.network.v1.NetworkService.ApplySettings:output_type -> google.protobuf.Empty
