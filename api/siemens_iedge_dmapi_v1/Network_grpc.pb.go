...
const (
	...
	NetworkService_CreateConnection_FullMethodName      = "/siemens.iedge.dmapi.network.v1.NetworkService/CreateConnection"
	NetworkService_RemoveConnection_FullMethodName      = "/siemens.iedge.dmapi.network.v1.NetworkService/RemoveConnection"
)
...
type NetworkServiceClient interface {
	...
	CreateConnection(ctx context.Context, in *ConnectionSettings, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// Removes an existing network connection based on the specified connection settings.
	RemoveConnection(ctx context.Context, in *ConnectionSettings, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *networkServiceClient) GetAllInterfaces(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*NetworkSettings, error) {
	...
	err := c.cc.Invoke(ctx, NetworkService_GetAllInterfaces_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *networkServiceClient) GetInterfaceWithMac(ctx context.Context, in *NetworkInterfaceRequest, opts ...grpc.CallOption) (*Interface, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Interface)
	err := c.cc.Invoke(ctx, NetworkService_GetInterfaceWithMac_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *networkServiceClient) GetInterfaceWithLabel(ctx context.Context, in *NetworkInterfaceRequestWithLabel, opts ...grpc.CallOption) (*Interface, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Interface)
	err := c.cc.Invoke(ctx, NetworkService_GetInterfaceWithLabel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *networkServiceClient) ApplySettings(ctx context.Context, in *NetworkSettings, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, NetworkService_ApplySettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *networkServiceClient) CreateConnection(ctx context.Context, in *ConnectionSettings, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, NetworkService_CreateConnection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *networkServiceClient) RemoveConnection(ctx context.Context, in *ConnectionSettings, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, NetworkService_RemoveConnection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NetworkServiceServer interface {
	...
	// Creates a new network connection with the specified connection settings.
	CreateConnection(context.Context, *ConnectionSettings) (*emptypb.Empty, error)
	// Removes an existing network connection based on the specified connection settings.
	RemoveConnection(context.Context, *ConnectionSettings) (*emptypb.Empty, error)
...
func (UnimplementedNetworkServiceServer) GetAllInterfaces(context.Context, *emptypb.Empty) (*NetworkSettings, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAllInterfaces not implemented")
}
func (UnimplementedNetworkServiceServer) GetInterfaceWithMac(context.Context, *NetworkInterfaceRequest) (*Interface, error) {
	return nil, status.Error(codes.Unimplemented, "method GetInterfaceWithMac not implemented")
}
func (UnimplementedNetworkServiceServer) GetInterfaceWithLabel(context.Context, *NetworkInterfaceRequestWithLabel) (*Interface, error) {
	return nil, status.Error(codes.Unimplemented, "method GetInterfaceWithLabel not implemented")
}
...
func (UnimplementedNetworkServiceServer) CreateConnection(context.Context, *ConnectionSettings) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateConnection not implemented")
}
func (UnimplementedNetworkServiceServer) RemoveConnection(context.Context, *ConnectionSettings) (*emptypb.Empty, error) {
...
func _NetworkService_CreateConnection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConnectionSettings)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NetworkServiceServer).CreateConnection(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NetworkService_CreateConnection_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetworkServiceServer).CreateConnection(ctx, req.(*ConnectionSettings))
	}
	return interceptor(ctx, in, info, handler)
}

func _NetworkService_RemoveConnection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConnectionSettings)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NetworkServiceServer).RemoveConnection(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NetworkService_RemoveConnection_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetworkServiceServer).RemoveConnection(ctx, req.(*ConnectionSettings))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NetworkService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NetworkService_CreateConnection_Handler,
		},
		{
			MethodName: "RemoveConnection",
			Handler:    _NetworkService_RemoveConnection_Handler,
		},
	},
